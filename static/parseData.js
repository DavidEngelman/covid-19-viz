    ...
    for (var key in res) {
        ...
        for (var elem in tmp) {
            ...
            for(var date in newObj) {
                ...
                final.push({"date": new Date(parseInt("20" + parts[2], 10), 
